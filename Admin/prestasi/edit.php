                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_prestasi" class="form-control" value="<?= htmlspecialchars($prestasi['nama_prestasi']) ?>" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="tahun" class="form-control" value="<?= $prestasi['tahun'] ?>" min="2000" max="<?= date('Y') + 1 ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="siswa" class="form-control" value="<?= htmlspecialchars($prestasi['siswa']) ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">Lokasi</label>
                                                <input type="text" name="lokasi" class="form-control" value="<?= htmlspecialchars($prestasi['lokasi']) ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-3 text-center" style="min-height:150px; background:#f8f9fa;">
                                        ...
                                        <img src="../../assets/prestasi/<?= $prestasi['gambar'] ?>" class="img-fluid rounded" style="max-height:150px;">
                                        <?php else: ?>
                            ...
                            <hr>
                            <button type="submit" class="btn btn-primary"><i class="bi bi-save me-2"></i> Update Prestasi</button>
