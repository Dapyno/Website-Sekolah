...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($error)) {
        ...
        if($guruModel->update($id, $data)) {
            header('Location: index.php?msg=Guru berhasil diperbarui&type=success');
            exit();
        } else {
...
<head>
    ...
    <title>Edit Guru - Admin SMP Al Islam Krian</title>
                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="jabatan" class="form-select" required>
                                                    ...
                                                    <option value="Staff Administrasi" <?= $guru['jabatan'] == 'Staff Administrasi' ? 'selected' : '' ?>>Staff Administrasi</option>
                                                    <option value="Tenaga Kependidikan" <?= $guru['jabatan'] == 'Tenaga Kependidikan' ? 'selected' : '' ?>>Tenaga Kependidikan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="mapel" class="form-control" value="<?= htmlspecialchars($guru['mapel']) ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tahun_bergabung" class="form-control" value="<?= htmlspecialchars($guru['tahun_bergabung']) ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">Pendidikan</label>
                                                <input type="text" name="pendidikan" class="form-control" value="<?= htmlspecialchars($guru['pendidikan']) ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="instagram" class="form-control" value="<?= htmlspecialchars($guru['instagram']) ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">LinkedIn</label>
                                                <input type="text" name="linkedin" class="form-control" value="<?= htmlspecialchars($guru['linkedin']) ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-select">
                                            ...
                                            <option value="inactive" <?= $guru['status'] == 'inactive' ? 'selected' : '' ?>>Non-Aktif</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="border rounded p-3 text-center" style="min-height:200px; background:#f8f9fa;">
                                        <?php if($guru['foto'] && file_exists('../../assets/guru/' . $guru['foto'])): ?>
                                        <img src="../../assets/guru/<?= $guru['foto'] ?>" class="img-fluid rounded" style="max-height:180px;">
                                        <?php else: ?>
                                        <i class="bi bi-image fs-1 text-muted"></i>
                                        <p class="text-muted small mt-2">Tidak ada foto</p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <button type="submit" class="btn btn-primary"><i class="bi bi-save me-2"></i> Update Guru</button>
