...
<head>
    ...
    <title>Tambah Berita - Admin SMP Islam Watestanjung</title>
    ...
    <link rel="stylesheet" href="../css/berita/create.css">
</head>
<body>
    ...
    <header class="flex justify-between items-center flex-wrap gap-3 pb-6 border-b border-gray-200">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                <i class="bi bi-plus-lg text-smp"></i> Tambah Berita
            </h1>
            <p class="text-sm text-gray-400 mt-0.5">Tambahkan berita baru</p>
        </div>
    ...
    <div class="mt-6 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <div class="flex items-center gap-2">
                ...
                <h3 class="font-semibold text-gray-800">Formulir Berita</h3>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="previewBox" class="preview-box">
                            ...
                            <img id="previewImage" style="display:none; max-height:180px; border-radius:0.5rem; object-fit:contain;" alt="Preview Gambar" />
                        </div>
                    </div>
                </div>
...
function previewImage(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            previewBox.style.borderColor = '#0E9F6E';
        ...
        previewBox.style.backgroundColor = '#F9FAFB';
    }
}
</script>
